...
def plot_attention(image, result, attention_plot):
    ...
    temp_image = image
    attention_plot = attention_plot.cpu().numpy()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='./data/val2014/COCO_val2014_000000290981.jpg')
    ...
    parser.add_argument('--dec_layers', type=int , default=1, help='number of decoder layers in transformer')
